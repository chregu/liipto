 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Log_Writer_apiFirebug extends Zend_Log_Writer_Abstract {

    /**
     * Maps logging priorities to logging display styles
     * @var array
     */
    protected $_priorityStyles = array( Zend_Log::EMERG => 'ERROR',
     ...
     * @var string
     */
    protected $_defaultPriorityStyle = 'LOG';
    ...
    protected function _write($event) {
        ...
        self::log($event['message'], $this->_priorityStyles[$event['priority']]);
    ...
    /**
     * Create a new instance of Zend_Log_Writer_apiFirebug
     * 
     * @param  array $config
     * @return Zend_Log_Writer_apiFirebug
     */
